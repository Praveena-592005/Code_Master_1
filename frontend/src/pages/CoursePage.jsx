...
try {
const res = await axios.post('http://localhost:5000/api/problems/complete-lesson', { 
userId, 
lessonId: courseId 
});
...
alert("Failed to save progress. Ensure your server is running and the route /api/problems/complete-lesson is correct.");
}
};
