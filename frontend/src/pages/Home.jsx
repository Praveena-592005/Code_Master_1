            ...
            <div style={{ 
                ...
                <div style={{ display: 'flex', gap: '20px', justifyContent: 'center' }}>
                    <button 
                        ...
                        style={{ background: '#ffa116', color: 'white', border: 'none', padding: '15px 40px', borderRadius: '30px', fontWeight: 'bold', cursor: 'pointer', fontSize: '18px' }}
                    >
                        Get Started
                    </button>
                    <button 
                        onClick={() => navigate('/problems')} 
                        style={{ background: 'transparent', color: 'white', border: '2px solid white', padding: '15px 40px', borderRadius: '30px', fontWeight: 'bold', cursor: 'pointer', fontSize: '18px' }}
                    >
                        Practice Code
                    </button>
                </div>
